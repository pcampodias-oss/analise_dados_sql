# 📊 Análise de Dados – Programa Minha Casa, Minha Vida
    ...
    | Atributo | Detalhes |
    |----------|----------|
    | **Registros Originais** | 7.390.483 |
    | **Registros Utilizados** | 10.000 (amostragem) |
    | **Motivo da Amostragem** | Limitações de recursos computacionais |
    ...
    - Período típico de estabelecimento financeiro e formação familiar
    ...
    2. **Expansão da Classe Média**: Classe média antes não contemplada agora recorre ao programa devido às altas taxas de juros
    ...
    Este projeto utiliza dados públicos do Governo Federal do Brasil e está disponível sob a licença **MIT**.
